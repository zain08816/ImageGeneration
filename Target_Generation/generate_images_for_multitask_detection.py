...
TARGET_SIZE_RANGE = range(45,60)
NOISE_DISTRIBUTION_MEAN_RANGE = range(-10, 11)
NOISE_DISTRIBUTION_STDDEV_RANGE = range(10, 20)
...
NUM_TARGETS_IN_IMAGE_RANGE = range(15, 18)
...
def choose_random_target_parameters():
	shape_class_dir = random.choice(os.listdir(SHAPE_DIR))
